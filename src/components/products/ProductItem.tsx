    ...
    return (
        ...
        >
            ...
            <div className="flex-1 flex flex-col p-5 gap-3 border-top border-white/30">
                <span className="text-lg font-semibold">{props.products.name}</span>
                <span className="text-sm border-b border-dashed self-start">
                    {products.specifications.emphasis}
                </span>
                {/* div adicionada para fazer os preços descerem e ficarem alinhados no final do card dos produtos. */}
                <div className="flex-1"></div> 
                <div className="flex flex-col">
                    <span className="text-sm text-gray-400 line-through">de {products.basePrice}</span>
                    <span className="text-xl font-semibold text-emerald-400">
                        por {products.promotionalPrice}
                    </span>
                </div>
                <button className="
